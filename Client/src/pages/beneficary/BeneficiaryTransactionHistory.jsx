    ...
    try {
      axiosInstance
        ...
        .then((response) => {
          ...
          setStatsData(response.data.data2);
          setIsLoading(false);
        })
        .catch((error) => {
                        ...
                        <div className="flex items-center gap-4 text-sm">
                          ...
                          {transaction.items.some(
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 font-medium text-red-600 hover:text-red-700"
                            >
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div className="rounded-lg border border-green-100 bg-green-50 p-5">
              ...
              <div className="mt-2 text-2xl font-bold text-green-900">
                {statsData?.totalSuccessfulTransaction.success}
              </div>
              <p className="mt-1 text-xs text-gray-600">
                {statsData?.totalSuccessfulTransaction.rate + "%"} success rate
              </p>
            </div>
