  ...
  return (
    <section>
      <div className="bg-blue-900 px-30 py-15">
        ...
        <button className="py-3 px-5 bg-white rounded-md text-blue-800 font-medium cursor-pointer hover:transform hover:scale-105 transition-transform">
          <MdOutlineSearch size={20} className="inline-block mr-2" />
          Search Distribution Centers
        </button>
        <button className="py-3 px-5 mx-8 rounded-md border-white border text-white font-medium cursor-pointer hover:transform hover:scale-105 transition-transform">
      ...
      <div className="px-30 py-15">
        ...
        <div className="flex justify-center my-10">
          ...
          <button className="py-3 px-4 bg-blue-800 text-white rounded-md rounded-l-none text-lg font-medium cursor-pointer">
            Search
          </button>
        </div>
        <div className="flex justify-between my-15">
          <div className="w-130 bg-blue-100 rounded-xl p-10">
            ...
            <button className="text-blue-800 font-medium cursor-pointer text-lg">
              Explore Shops
          ...
          <div className="w-130 bg-green-100 rounded-xl p-10">
            ...
            <button className="text-green-800 font-medium cursor-pointer text-lg">
              View Districts
              <FaArrowRightLong size={20} className="inline-block ml-2" />
            </button>
          </div>
          <div className="w-130 bg-purple-100 rounded-xl p-10">
            ...
            <button className="text-purple-800 font-medium cursor-pointer text-lg">
              View Analytics
              <FaArrowRightLong size={20} className="inline-block ml-2" />
            </button>
          </div>
